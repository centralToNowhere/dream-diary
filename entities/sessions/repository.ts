...
export const createSession = async function (userData: UserAuthData): Promise<SessionDTO | null> {
...
export const refreshSession = async function (refreshToken: string): Promise<SessionRefreshResponse | null> {
  const refreshTokenHash = hashToken(refreshToken);
