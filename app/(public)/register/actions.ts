...
import { createUser } from "@/entities/users/repository";
import { createUserInputSchema } from "@/entities/users/types";
...
export async function registerAction(
  ...
  try {
    ...
    return { error: "Не удалось создать аккаунт. Попробуй ещё раз", success: false };
  }
}
