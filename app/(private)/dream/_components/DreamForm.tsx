...
type DreamFormProps = {
  ...
  action: (
    formData: FormData,
  ) => DreamFormState | Promise<DreamFormState>;
};
    ...
    <Form onSubmit={onSubmit} noValidate>
      <Form.Field>
        ...
        <Input
          ...
          {...register("title")}
        />
        {errors.title && <p id="title-error" className={styles.error}>{errors.title.message}</p>}
      </Form.Field>
      ...
      <Form.Field>
        ...
        />
        {errors.description && <p id="description-error" className={styles.error}>{errors.description.message}</p>}
      </Form.Field>
      ...
      <div className={styles.grid}>
        <Form.Field>
          ...
          <Input
            ...
            {...register("dreamDate")}
          />
          {errors.dreamDate && <p id="dreamDate-error" className={styles.error}>{errors.dreamDate.message}</p>}
        </Form.Field>
        ...
        <Form.Field>
          ...
          <Input
            ...
            {...register("rating")}
          />
          {errors.rating && <p id="rating-error" className={styles.error}>{errors.rating.message}</p>}
        </Form.Field>
      </div>
